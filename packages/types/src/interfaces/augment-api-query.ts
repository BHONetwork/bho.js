...
import type { BTreeMap, BTreeSet, Bytes, Null, Option, U256, U8aFixed, Vec, WrapperKeepOpaque, WrapperOpaque, bool, u128, u16, u32, u64 } from '@polkadot/types-codec';
import type { AnyNumber, ITuple } from '@polkadot/types-codec/types';
import type { AccountId32, Call, H160, H256, Perbill, Percent, Permill } from '@polkadot/types/interfaces/runtime';
import type { BeefyPrimitivesCryptoPublic, BeefyPrimitivesMmrBeefyNextAuthoritySet, BholdusBridgeNativeTransferOutboundTransferInfo, BholdusMemoMemoInfo, BholdusTokensApproval, BholdusTokensAssetBalance, BholdusTokensAssetDetails, BholdusTokensAssetMetadata, BholdusTokensRegistration, EthereumBlock, EthereumReceiptReceiptV3, EthereumTransactionTransactionV2, FpRpcTransactionStatus, FrameSupportWeightsPerDispatchClassU64, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, PalletAuthorshipUncleEntryItem, PalletBagsListListBag, PalletBagsListListNode, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesReleases, PalletBalancesReserveData, PalletBountiesBounty, PalletChildBountiesChildBounty, PalletCollectiveVotes, PalletContractsStorageDeletedContract, PalletContractsStorageRawContractInfo, PalletContractsWasmOwnerInfo, PalletContractsWasmPrefabWasmModule, PalletElectionProviderMultiPhasePhase, PalletElectionProviderMultiPhaseReadySolution, PalletElectionProviderMultiPhaseRoundSnapshot, PalletElectionProviderMultiPhaseSignedSignedSubmission, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, PalletGrandpaStoredPendingChange, PalletGrandpaStoredState, PalletIdentityRegistrarInfo, PalletIdentityRegistration, PalletImOnlineBoundedOpaqueNetworkState, PalletImOnlineSr25519AppSr25519Public, PalletMultisigMultisig, PalletNominationPoolsBondedPoolInner, PalletNominationPoolsPoolMember, PalletNominationPoolsRewardPool, PalletNominationPoolsSubPools, PalletPreimageRequestStatus, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletRecoveryActiveRecovery, PalletRecoveryRecoveryConfig, PalletSchedulerScheduledV3, PalletStakingActiveEraInfo, PalletStakingEraRewardPoints, PalletStakingExposure, PalletStakingForcing, PalletStakingNominations, PalletStakingReleases, PalletStakingRewardDestination, PalletStakingSlashingSlashingSpans, PalletStakingSlashingSpanRecord, PalletStakingStakingLedger, PalletStakingUnappliedSlash, PalletStakingValidatorPrefs, PalletTransactionPaymentReleases, PalletTreasuryProposal, PhoenixRuntimePalletsSessionSessionKeys, SpAuthorityDiscoveryAppPublic, SpConsensusAuraSr25519AppSr25519Public, SpCoreCryptoKeyTypeId, SpNposElectionsElectionScore, SpRuntimeDigest, SpStakingOffenceOffenceDetails, SupportNftClassInfo, SupportNftMarketplaceAccessControlPermission, SupportNftMarketplaceAccessControlRoleType, SupportNftMarketplaceAuctionTimeAuctionListingInfo, SupportNftMarketplaceFixedPriceFixedPriceListingInfo, SupportNftMarketplaceItemListingInfo, SupportNftMarketplaceMarketplaceFeeInfo, SupportNftMarketplacePalletManagementInfo, SupportNftMarketplaceRoyaltyInfo, SupportNftTokenInfo } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  export interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    bholdusSupportNFT: {
       ...
       * Lock NFT on account
       **/
      lockableNFT: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: u32 | AnyNumber | Uint8Array, arg3: u64 | AnyNumber | Uint8Array) => Observable<Null>, [AccountId32, u32, u64]> & QueryableStorageEntry<ApiType, [AccountId32, u32, u64]>;
      /**
       ...
       * Store group info
       **/
      tokensByGroup: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: u32 | AnyNumber | Uint8Array, arg3: u64 | AnyNumber | Uint8Array) => Observable<Option<Null>>, [u32, u32, u64]> & QueryableStorageEntry<ApiType, [u32, u32, u64]>;
      /**
    ...
    memo: {
      amountFreeTx: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      memo: AugmentedQuery<ApiType, (arg1: u16 | AnyNumber | Uint8Array, arg2: Bytes | string | Uint8Array) => Observable<Option<BholdusMemoMemoInfo>>, [u16, Bytes]> & QueryableStorageEntry<ApiType, [u16, Bytes]>;
      memoCounter: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<u128>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PhoenixRuntimePalletsSessionSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, PhoenixRuntimePalletsSessionSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    supportNFTMarketplace: {
      accessControl: AugmentedQuery<ApiType, (arg1: SupportNftMarketplaceAccessControlRoleType | { Manager: any } | { Member: any } | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<Option<Vec<SupportNftMarketplaceAccessControlPermission>>>, [SupportNftMarketplaceAccessControlRoleType, AccountId32]> & QueryableStorageEntry<ApiType, [SupportNftMarketplaceAccessControlRoleType, AccountId32]>;
      /**
       * NFT Blacklist
       **/
      blacklist: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Option<Bytes>>, [u32, u64]> & QueryableStorageEntry<ApiType, [u32, u64]>;
      /**
       * Listing NFT on marketplace
       **/
      fixedPriceListing: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: u32 | AnyNumber | Uint8Array, arg3: u64 | AnyNumber | Uint8Array) => Observable<Option<SupportNftMarketplaceFixedPriceFixedPriceListingInfo>>, [AccountId32, u32, u64]> & QueryableStorageEntry<ApiType, [AccountId32, u32, u64]>;
      /**
       * History Trading Information
       **/
      fixedPriceOrder: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: u32 | AnyNumber | Uint8Array, arg3: u64 | AnyNumber | Uint8Array) => Observable<Option<SupportNftMarketplaceFixedPriceFixedPriceListingInfo>>, [AccountId32, u32, u64]> & QueryableStorageEntry<ApiType, [AccountId32, u32, u64]>;
      itemListing: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: u32 | AnyNumber | Uint8Array, arg3: u64 | AnyNumber | Uint8Array) => Observable<Option<SupportNftMarketplaceItemListingInfo>>, [AccountId32, u32, u64]> & QueryableStorageEntry<ApiType, [AccountId32, u32, u64]>;
      marketplaceFee: AugmentedQuery<ApiType, () => Observable<Option<SupportNftMarketplaceMarketplaceFeeInfo>>, []> & QueryableStorageEntry<ApiType, []>;
      palletManagement: AugmentedQuery<ApiType, () => Observable<Option<SupportNftMarketplacePalletManagementInfo>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Royalty
       **/
      royalty: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Option<SupportNftMarketplaceRoyaltyInfo>>, [u32, u64]> & QueryableStorageEntry<ApiType, [u32, u64]>;
      /**
       * Auction Sale
       **/
      timeAuction: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: u32 | AnyNumber | Uint8Array, arg3: u64 | AnyNumber | Uint8Array) => Observable<Option<SupportNftMarketplaceAuctionTimeAuctionListingInfo>>, [AccountId32, u32, u64]> & QueryableStorageEntry<ApiType, [AccountId32, u32, u64]>;
      /**
       * NFT listed on market check by owner, class ID, token ID
       **/
      tokenListingByOwner: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: u32 | AnyNumber | Uint8Array, arg3: u64 | AnyNumber | Uint8Array) => Observable<Null>, [AccountId32, u32, u64]> & QueryableStorageEntry<ApiType, [AccountId32, u32, u64]>;
      /**
       * User Blacklist
       **/
      userBlacklist: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<Bytes>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    tokens: {
      ...
      assetsBlacklist: AugmentedQuery<ApiType, () => Observable<BTreeSet<ITuple<[Bytes, Bytes]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
