...
import type { BTreeMap, Bytes, Compact, Option, U256, U8aFixed, Vec, WrapperKeepOpaque, bool, u128, u16, u32, u64, u8 } from '@polkadot/types-codec';
...
import type { BholdusNftMarketplaceAuctionTimeAuctionSetting, BholdusNftMarketplaceFixedPriceFixedPriceSetting, BholdusTokensAssetIdentity, BholdusTokensDestroyWitness, EthereumTransactionTransactionV2, FrameSupportScheduleMaybeHashed, PalletElectionProviderMultiPhaseRawSolution, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletImOnlineHeartbeat, PalletImOnlineSr25519AppSr25519Signature, PalletMultisigTimepoint, PalletNominationPoolsBondExtra, PalletNominationPoolsConfigOpAccountId32, PalletNominationPoolsConfigOpU128, PalletNominationPoolsConfigOpU32, PalletNominationPoolsPoolState, PalletStakingPalletConfigOpPerbill, PalletStakingPalletConfigOpPercent, PalletStakingPalletConfigOpU128, PalletStakingPalletConfigOpU32, PalletStakingRewardDestination, PalletStakingValidatorPrefs, PhoenixRuntimeOriginCaller, PhoenixRuntimePalletsProxyProxyType, PhoenixRuntimePalletsSessionSessionKeys, SpFinalityGrandpaEquivocationProof, SpNposElectionsElectionScore, SpNposElectionsSupport, SpRuntimeHeader, SpSessionMembershipProof, SupportNftMarketplaceAccessControlRoleType } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    bridgeNativeTransfer: {
       ...
       **/
      forceRegisterChain: AugmentedSubmittable<(chain: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u16]>;
      /**
       ...
       * Only `AdminOrigin` can access this operation
       **/
      forceUnregisterChain: AugmentedSubmittable<(chain: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u16]>;
      /**
       * Unregister relayer account
       * Only `AdminOrigin` can access this operation
       **/
      forceUnregisterRelayer: AugmentedSubmittable<(relayer: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      /**
       * Withdraw tokens locked in this pallet to some account
       * This operation is mainly used for any migration in the future
       * Only `AdminOrigin` can access this operation
       **/
      forceWithdraw: AugmentedSubmittable<(to: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      /**
       * Outbound
       ...
       * succeeds.
       **/
      initiateTransfer: AugmentedSubmittable<(to: Bytes | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, targetChain: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, u128, u16]>;
      /**
       * Inbound
       * Relayer call this to release tokens to user corresponding to transfer sent from other
       * chains.
       **/
      releaseTokens: AugmentedSubmittable<(transferId: u128 | AnyNumber | Uint8Array, from: Bytes | string | Uint8Array, to: AccountId32 | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, Bytes, AccountId32, u128]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    memo: {
      create: AugmentedSubmittable<(chainId: u16 | AnyNumber | Uint8Array, txnHash: Bytes | string | Uint8Array, content: Bytes | string | Uint8Array, sender: Bytes | string | Uint8Array, receiver: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u16, Bytes, Bytes, Bytes, Bytes]>;
      setAmountFreeTx: AugmentedSubmittable<(amountFreeTx: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    nftMarketplace: {
      approveListing: AugmentedSubmittable<(token: ITuple<[u32, u64]> | [u32 | AnyNumber | Uint8Array, u64 | AnyNumber | Uint8Array]) => SubmittableExtrinsic<ApiType>, [ITuple<[u32, u64]>]>;
      ban: AugmentedSubmittable<(token: ITuple<[u32, u64]> | [u32 | AnyNumber | Uint8Array, u64 | AnyNumber | Uint8Array], reason: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ITuple<[u32, u64]>, Bytes]>;
      banUser: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array, reason: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Bytes]>;
      buyNow: AugmentedSubmittable<(token: ITuple<[u32, u64]> | [u32 | AnyNumber | Uint8Array, u64 | AnyNumber | Uint8Array]) => SubmittableExtrinsic<ApiType>, [ITuple<[u32, u64]>]>;
      cancelListing: AugmentedSubmittable<(token: ITuple<[u32, u64]> | [u32 | AnyNumber | Uint8Array, u64 | AnyNumber | Uint8Array], reason: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ITuple<[u32, u64]>, Bytes]>;
      createFixedPriceListing: AugmentedSubmittable<(token: ITuple<[u32, u64]> | [u32 | AnyNumber | Uint8Array, u64 | AnyNumber | Uint8Array], info: BholdusNftMarketplaceFixedPriceFixedPriceSetting | { price?: any; currencyId?: any; expiredTime?: any; royalty?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ITuple<[u32, u64]>, BholdusNftMarketplaceFixedPriceFixedPriceSetting]>;
      createTimeAuctionListing: AugmentedSubmittable<(token: ITuple<[u32, u64]> | [u32 | AnyNumber | Uint8Array, u64 | AnyNumber | Uint8Array], info: BholdusNftMarketplaceAuctionTimeAuctionSetting | { minPrice?: any; currencyId?: any; auctionEnd?: any; royalty?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ITuple<[u32, u64]>, BholdusNftMarketplaceAuctionTimeAuctionSetting]>;
      grantRole: AugmentedSubmittable<(role: SupportNftMarketplaceAccessControlRoleType | { Manager: any } | { Member: any } | string | Uint8Array, account: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [SupportNftMarketplaceAccessControlRoleType, AccountId32]>;
      rejectListing: AugmentedSubmittable<(token: ITuple<[u32, u64]> | [u32 | AnyNumber | Uint8Array, u64 | AnyNumber | Uint8Array], reason: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ITuple<[u32, u64]>, Bytes]>;
      revokeRole: AugmentedSubmittable<(role: SupportNftMarketplaceAccessControlRoleType | { Manager: any } | { Member: any } | string | Uint8Array, account: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [SupportNftMarketplaceAccessControlRoleType, AccountId32]>;
      setMarketplaceFee: AugmentedSubmittable<(serviceFee: ITuple<[u32, u32]> | [u32 | AnyNumber | Uint8Array, u32 | AnyNumber | Uint8Array], beneficiary: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ITuple<[u32, u32]>, AccountId32]>;
      unban: AugmentedSubmittable<(token: ITuple<[u32, u64]> | [u32 | AnyNumber | Uint8Array, u64 | AnyNumber | Uint8Array]) => SubmittableExtrinsic<ApiType>, [ITuple<[u32, u64]>]>;
      unbanUser: AugmentedSubmittable<(account: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    proxy: {
       ...
       * # </weight>
       **/
      addProxy: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, proxyType: PhoenixRuntimePalletsProxyProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, PhoenixRuntimePalletsProxyProxyType, u32]>;
      /**
       ...
       **/
      anonymous: AugmentedSubmittable<(proxyType: PhoenixRuntimePalletsProxyProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [PhoenixRuntimePalletsProxyProxyType, u32, u16]>;
      /**
       ...
       * # </weight>
       **/
      killAnonymous: AugmentedSubmittable<(spawner: AccountId32 | string | Uint8Array, proxyType: PhoenixRuntimePalletsProxyProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, PhoenixRuntimePalletsProxyProxyType, u16, Compact<u32>, Compact<u32>]>;
      /**
       ...
       * # </weight>
       **/
      proxy: AugmentedSubmittable<(real: AccountId32 | string | Uint8Array, forceProxyType: Option<PhoenixRuntimePalletsProxyProxyType> | null | object | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Option<PhoenixRuntimePalletsProxyProxyType>, Call]>;
      /**
       ...
       * # </weight>
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, real: AccountId32 | string | Uint8Array, forceProxyType: Option<PhoenixRuntimePalletsProxyProxyType> | null | object | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, AccountId32, Option<PhoenixRuntimePalletsProxyProxyType>, Call]>;
      /**
       ...
       * # </weight>
       **/
      removeProxy: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, proxyType: PhoenixRuntimePalletsProxyProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, PhoenixRuntimePalletsProxyProxyType, u32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    session: {
       ...
       * # </weight>
       **/
      setKeys: AugmentedSubmittable<(keys: PhoenixRuntimePalletsSessionSessionKeys | { grandpa?: any; aura?: any; imOnline?: any; authorityDiscovery?: any; beefy?: any } | string | Uint8Array, proof: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PhoenixRuntimePalletsSessionSessionKeys, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    tokens: {
       ...
       * Weight: `O(1)`
       **/
      create: AugmentedSubmittable<(admin: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, minBalance: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, u128]>;
      createAndMint: AugmentedSubmittable<(admin: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, name: Bytes | string | Uint8Array, symbol: Bytes | string | Uint8Array, decimals: u8 | AnyNumber | Uint8Array, beneficiary: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, supply: Compact<u128> | AnyNumber | Uint8Array, minBalance: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MultiAddress, Bytes, Bytes, u8, MultiAddress, Compact<u128>, u128]>;
      /**
       ...
       * - `a = witness.approvals`
       **/
      destroy: AugmentedSubmittable<(id: u64 | AnyNumber | Uint8Array, witness: BholdusTokensDestroyWitness | { accounts?: any; sufficients?: any; approvals?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, BholdusTokensDestroyWitness]>;
      /**
       ...
       * #</weight>
       **/
      setIdentity: AugmentedSubmittable<(id: u64 | AnyNumber | Uint8Array, info: BholdusTokensAssetIdentity | { additional?: any; basicInformation?: any; socialProfiles?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, BholdusTokensAssetIdentity]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      verifyAsset: AugmentedSubmittable<(id: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    utility: {
       ...
       * # </weight>
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: PhoenixRuntimeOriginCaller | { system: any } | { Void: any } | { Council: any } | { Ethereum: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PhoenixRuntimeOriginCaller, Call]>;
      /**
       * Send a batch of dispatch calls.
